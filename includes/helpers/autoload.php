...
/**
 * Autocargador de modelos assets
 *
 * @param string $clase El nombre del modelo.
 * @return void
 */
function autocargadorModelosAssets($clase) {

    $modelo = INCLUDE_PATH.'models/assets/'.$clase.'.php';
...
spl_autoload_register('autocargadorModelosAssets');
