...
Class Input_captcha extends Campo{
	...
	public $site_key	= '6LflJBUUAAAAAJwKlQSMiNbOV05RDnbG64TWF2iM';
	public $secret_key 	= '6LflJBUUAAAAAGRQedLm-ZdrtHM5u-1t0trOSku_';

	function __construct( $datos ){

		parent::__construct( $datos );

		$this->site_key 	= $this->site_key==''   ?  '6LflJBUUAAAAAJwKlQSMiNbOV05RDnbG64TWF2iM' : $this->site_key;
		$this->secret_key 	= $this->secret_key=='' ?  '6LflJBUUAAAAAGRQedLm-ZdrtHM5u-1t0trOSku_' : $this->secret_key;
